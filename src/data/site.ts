export const site = {
  name: 'Dr. Henry Bory Prevez',
  shortName: 'Henry Bory Prevez',
...
export const profile = {
  fullName: 'Henry Bory Prevez',
  displayName: 'Dr. Henry Bory Prevez',
  degree: 'Dr. en Ciencias',
  role: 'Profesor Titular',
  institution: 'Universidad de Oriente',
  location: 'Santiago de Cuba, Cuba',
  areas:
    'Automática, control avanzado, electrónica de potencia, energías renovables, modelado matemático y sistemas dinámicos.',
  qrStatus: 'QR profesional generado hacia la página /cv; debe validarse después del primer despliegue público.',
};
