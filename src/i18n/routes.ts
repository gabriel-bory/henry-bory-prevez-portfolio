...
export const localizedRoutes: Record<RouteKey, Record<Locale, string>> = {
  ...
  "researchBioPhysics": {
    ...
    "pt": "pt/investigacao/biofisica-oncologia-matematica/",
  ...
  "researchEnergyPower": {
    ...
    "pt": "pt/investigacao/energia-eletronica-potencia/",
  ...
  "researchPelton": {
    ...
    "pt": "pt/investigacao/micro-hidreletricas-pelton/",
  ...
  "researchOtec": {
    ...
    "pt": "pt/investigacao/otec-energia-oceanica/",
    "fr": "fr/recherche/otec-energie-oceanique/",
    "de": "de/forschung/otec-ozeanenergie/",
...
export const getRouteKeyFromPath = (pathname: string, base = import.meta.env.BASE_URL): RouteKey => {
  ...
  const publicationRoots = Object.values(localizedRoutes.publicationDetail);
  if (publicationRoots.some((root) => normalizedWithSlash.startsWith(root))) return 'publicationDetail';

  const researchRoots = Object.values(localizedRoutes.research);
  if (researchRoots.some((root) => normalizedWithSlash.startsWith(root))) return 'research';
